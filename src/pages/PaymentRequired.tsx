  ...
  return (
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="mx-auto w-full max-w-4xl">
        ...
        {/* Aviso dos pasos */}
        <div className="mb-6 rounded-lg border border-border bg-secondary px-5 py-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-foreground">Setup inicial</p>
                <p className="text-xs text-muted-foreground">Instalación, video de capacitación y carga de datos — lo coordinamos con vos.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-foreground">Suscripción mensual</p>
                <p className="text-xs text-muted-foreground">Débito automático mensual por Mercado Pago — lo configurás ahora.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              >
                ...
                >
                  ...
                  <p className="mt-1 text-2xl font-bold">
                    ...
                    <span className={`ml-1 text-xs font-semibold ${isSelected ? "text-white/50" : "text-muted-foreground"}`}>/ mes</span>
                  </p>
                  <p className={`mt-1 text-xs ${isSelected ? "text-white/40" : "text-muted-foreground"}`}>
        ...
        {/* CTA */}
        <div className="mt-6 rounded-xl border border-border bg-card p-5 shadow-[0_18px_50px_-24px_rgba(0,0,0,0.15)]">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <div>
              ...
              <p className="mt-0.5 text-xl font-bold text-foreground">
                {formatARS(plan.monthly)}<span className="text-sm font-medium text-muted-foreground"> / mes</span>
              </p>
...
const BlockedScreen = ({ restaurantId }: { restaurantId: string }) => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md rounded-xl border border-border bg-card p-8 shadow-[0_18px_50px_-18px_rgba(0,0,0,0.22)]">
        ...
        <div className="mt-7 rounded-lg border border-amber-800/50 bg-amber-950/30 p-4">
          <div className="flex items-start gap-3">
            <MessageCircleWarning size={20} className="mt-0.5 text-amber-400" />
            <div>
        ...
        <div className="mt-7 space-y-3">
          ...
          <button
            ...
            className="h-12 w-full rounded-lg border border-border bg-card text-sm font-semibold text-foreground transition hover:bg-secondary"
          >
            Reintentar acceso
          </button>
        </div>
