    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      <div className="mx-auto w-full max-w-lg">
        ...
        <main className="px-4 py-4">
          ...
          <section className="mb-5 rounded-xl border border-slate-200 bg-card p-5 text-center shadow-sm">
          ...
          {sessionId && !isLoading && total <= 0 && (
            <div className="mb-4 rounded-lg border border-amber-300 bg-amber-950/30 px-4 py-3 text-sm font-medium text-amber-400">
              Todavía no encontramos consumos cargados para esta sesión.
            </div>
          )}

          <section className="mb-5 rounded-xl border border-slate-200 bg-card p-4 shadow-sm">
            ...
            {isLoading ? (
              ...
              <div className="overflow-hidden rounded-lg border border-slate-100">
                <div className="divide-y divide-slate-100">
                  {billItems.map((item) => (
                    <div key={item.key} className="bg-card px-3 py-3">
          ...
          <section className="mb-6">
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 bg-card p-4 shadow-sm">
              <input
                type="checkbox"
                checked={splitBill}
