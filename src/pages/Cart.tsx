      ...
      <div className="mx-auto w-full max-w-lg">
          ...
          <div className="px-4 pb-4 pt-[max(12px,env(safe-area-inset-top))]">
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={isBusy}
                className="flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-card text-slate-700 shadow-sm disabled:opacity-50"
              >
                <ArrowLeft size={18} />
              </button>
        ...
        {error && (
          <div className="px-4 pt-4">
            <div className="rounded-lg border border-red-300 bg-red-950/30 px-4 py-3 text-sm font-medium text-red-400">
              {error}
            </div>
          </div>
        )}
        ...
        {isValidatingSession ? (
          <div className="px-4 py-10">
            <div className="rounded-xl border border-slate-200 bg-card p-6 text-center shadow-sm">
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {hasObservation && (
                        <div className="mt-3 rounded-lg border border-amber-800/50 bg-amber-950/30 px-3 py-2.5">
                      ...
                      <div className="mt-4 flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            disabled={isBusy}
                            className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-card text-slate-700 disabled:opacity-50"
                          >
                            <Minus size={14} />
                          </button>
          ...
          <div className="mx-auto max-w-lg">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                disabled={isBusy}
                className="h-12 w-full rounded-lg border border-slate-200 bg-card text-sm font-semibold text-slate-700 disabled:opacity-50"
              >
