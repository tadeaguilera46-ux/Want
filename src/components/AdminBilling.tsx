    ...
    <div className="space-y-6">
      ...
      {isPastDue && (
        <div className="flex items-start gap-4 rounded-xl border border-amber-200 bg-amber-50 p-5">
          ...
          <div>
            <p className="font-bold text-amber-900">Suscripción vencida</p>
      ...
      <div className="relative overflow-hidden rounded-xl border border-white/10 bg-zinc-950 p-6 text-white shadow-xl lg:p-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {PLANS.map((plan) => {
            ...
            return (
              <div
                key={plan.key}
                className={`relative flex flex-col overflow-hidden rounded-xl border p-6 shadow-sm transition ${
                  isCurrent
              ...
              >
                ...
                {isCurrent ? (
                  <div className="flex h-12 items-center justify-center rounded-lg border-2 border-zinc-200 text-sm font-bold text-zinc-500">
                    Plan actual
                  </div>
                ) : (
                  <button
        ...
        <div className="rounded-xl border border-red-200 bg-red-50 p-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="flex h-11 shrink-0 items-center gap-2 rounded-lg border border-red-300 bg-white px-5 text-sm font-bold text-red-700 transition hover:bg-red-100 disabled:opacity-60"
            >
      ...
      {paymentsLoading ? (
        ...
        <>
          ...
          <div className="mb-5 grid grid-cols-3 gap-3">
            <div className="flex flex-col items-center gap-1 rounded-lg border border-emerald-100 bg-emerald-50 px-3 py-3">
              <CheckCircle2 size={18} className="text-emerald-600" />
              <p className="text-xl font-bold text-emerald-800">{emitidas.length}</p>
              <p className="text-[11px] font-bold uppercase tracking-wide text-emerald-600">
                Emitidas
              </p>
            </div>
            <div className="flex flex-col items-center gap-1 rounded-lg border border-amber-100 bg-amber-50 px-3 py-3">
              <Clock size={18} className="text-amber-600" />
              <p className="text-xl font-bold text-amber-800">{pendientes.length}</p>
              <p className="text-[11px] font-bold uppercase tracking-wide text-amber-600">
                Pendientes
              </p>
            </div>
            <div className="flex flex-col items-center gap-1 rounded-lg border border-red-100 bg-red-50 px-3 py-3">
              <XCircle size={18} className="text-red-500" />
              <p className="text-xl font-bold text-red-700">{fallidas.length}</p>
            ...
            <div className="space-y-2">
              ...
              {filtered.length > 5 && (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-200 bg-zinc-50 py-2.5 text-sm font-bold text-zinc-600 transition hover:bg-zinc-100"
                >
                  {showAllPayments ? (
                    <>
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm font-bold text-zinc-950">{typeLabel}</p>
