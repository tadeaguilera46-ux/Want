...
const getStatusStyle = (status?: SubscriptionStatus) => {
  switch (status) {
    case "active":
      return "border-emerald-800/50 bg-emerald-100 text-emerald-400";
    case "trial":
      return "border-blue-800/50 bg-blue-100 text-blue-400";
    case "past_due":
      return "border-amber-800/50 bg-amber-100 text-amber-400";
    case "blocked":
      return "border-red-800/50 bg-red-100 text-red-800";
    default:
    ...
    <section className="mb-6 rounded-xl border border-border bg-card p-5 shadow-sm">
      <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        ...
        <button
          ...
          className="flex h-11 items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 text-sm font-bold text-foreground transition hover:bg-secondary disabled:opacity-60"
        >
          <RefreshCw
            size={16}
      ...
      <div className="mb-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-xl border border-border bg-secondary p-4">
          <TrendingUp className="mb-3 text-foreground" size={22} />
              ...
              >
                <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  <div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="rounded-full bg-card px-3 py-1 text-xs font-bold text-foreground shadow-sm">
                ...
                <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                  <label className="grid gap-1 text-xs font-bold text-muted-foreground">
                    ...
                    <select
                      ...
                      className="h-11 rounded-lg border border-border bg-card px-3 text-sm text-foreground outline-none focus:ring-2 focus:ring-ring/40"
                    >
                  ...
                  <label className="flex h-11 items-center gap-2 self-end rounded-lg border border-border bg-card px-3 text-sm font-bold text-foreground">
                    <input
                ...
                <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <button
                    ...
                    className="flex h-11 items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 text-sm font-bold text-foreground transition hover:bg-secondary"
                  >
                    <History size={16} />
                    ...
                    {restaurantPayments.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {restaurantPayments.slice(0, 8).map((payment) => (
                          <div
                            key={payment.id}
                            className="flex flex-col gap-1 rounded-lg bg-secondary px-3 py-3 sm:flex-row sm:items-center sm:justify-between"
                          >
                            <div>
