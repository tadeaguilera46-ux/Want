...
const MOVEMENT_STYLE: Record<string, { label: string; className: string }> = {
  ...
  devolucion: { label: "Devolución",  className: "bg-amber-100 text-amber-800 border border-amber-200" },
};
                ...
                return (
                  <tr key={entry.id} className="hover:bg-zinc-50/60">
                    ...
                    <td className={`px-4 py-2.5 text-right tabular-nums font-medium ${
                      entry.movementType === "entrada" || entry.movementType === "creacion" || entry.movementType === "devolucion"
                        ? "text-emerald-600"
